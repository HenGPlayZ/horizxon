        ...
        <div className="container-responsive">
          <div className="flex flex-col lg:flex-row items-center min-h-[calc(100vh-10rem)]">
            ...
            >
              ...
              {/* Portfolio PDF Download Link - Clean minimal design */}
              <div
                className="flex justify-center lg:justify-start items-center animate-fade-in mt-8"
                style={{
              ...
              >
                <a
                  ...
                  className="group inline-flex items-center gap-3 px-4 py-2 rounded-lg transition-all duration-300 hover:bg-white/5"
                  style={{
                ...
                >
                  ...
                  <span className="text-sm font-medium group-hover:text-white transition-colors">
                    Download Portfolio & Services Guide
                  </span>
                  <svg
